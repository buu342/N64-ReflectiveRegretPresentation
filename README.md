...
* `Images` - The source files for images used in the presentation
* `Models` - The source files for models used in the presentation
* `Presentation` - A (backup) PowerPoint of the presentation, a rough draft of the script that was used, and a collection of addendums + clarifications. Be aware that the script is not final nor a transcript, it was just written to help me structure the presentation.
